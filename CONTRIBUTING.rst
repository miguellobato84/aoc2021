...
Welcome to ``aoc`` contributor's guide.
...
If you experience bugs or general issues with ``aoc``, please have a look
...
You can help improve ``aoc`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``aoc`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``aoc``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n aoc python=3 six virtualenv pytest pytest-cov
    conda activate aoc
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/aoc.git
    cd aoc
...
#. Install |pre-commit|_::
   ...
   ``aoc`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/aoc
.. _issue tracker: https://github.com/<USERNAME>/aoc/issues
.. <-- end -->
